...
export const createFragments = (dtls: DtlsContext) => (handshakes: Handshake[]) => {
...
export const createPlaintext = (dtls: DtlsContext) => (fragments: Message[], recordSequenceNumber: number) => {
