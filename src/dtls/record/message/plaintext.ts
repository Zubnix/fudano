...
export class DtlsPlaintext {
  static readonly spec = {
    ...
    fragment: types.buffer((context: any) => context.current.recordLayerHeader.contentLen),
  }

  constructor(public recordLayerHeader: typeof DtlsPlaintext.spec.recordLayerHeader, public fragment: Buffer) {}
