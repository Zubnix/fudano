...
import { CipherSuite, NamedCurveAlgorithmList, NamedCurveAlgorithms, SignatureAlgorithm } from '../../cipher/const'
...
export const flight2 =
  (udp: TransportContext, dtls: DtlsContext, cipher: CipherContext, srtp: SrtpContext) =>
        ...
        case EllipticCurves.type:
          {
            ...
            const curve = curves.find((curve) => NamedCurveAlgorithmList.includes(curve as any)) as NamedCurveAlgorithms
