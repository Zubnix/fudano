...
export async function getGlobalIp(stunServer?: Address, interfaceAddresses?: InterfaceAddresses) {
  ...
  const candidate = await serverReflexiveCandidate(protocol, ['stun.l.google.com', 19302])
