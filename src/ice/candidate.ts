...
export class Candidate {
  ...
  canPairWith(other: Candidate) {
    ...
    return (
      this.component === other.component && this.transport.toLowerCase() === other.transport.toLowerCase() && a === b
    )
  }
...
export function candidateFoundation(candidateType: string, candidateTransport: string, baseAddress: string) {
  // """
...
// priorityを決める
export function candidatePriority(candidateComponent: number, candidateType: string, localPref = 65535) {
