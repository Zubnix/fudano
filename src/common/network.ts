...
export const interfaceAddress = (type: SocketType, interfaceAddresses: InterfaceAddresses | undefined) =>
  interfaceAddresses ? interfaceAddresses[type] : undefined

export async function randomPort(protocol: SocketType = 'udp4', interfaceAddresses?: InterfaceAddresses) {
...
export async function randomPorts(num: number, protocol: SocketType = 'udp4', interfaceAddresses?: InterfaceAddresses) {
